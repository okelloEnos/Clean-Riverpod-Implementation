...
import 'package:official_riverpod_test/todo.dart';
...
/// the different ways to filter todos
enum TodoListFilter{
  all,
  active,
  completed
        ...
        body: ListView(
          ...
          children: [
            ...
            for(var i = 0; i < todos.length; i++) ...[
              ...
              Dismissible(key: ValueKey(todos[i].id),
                  onDismissed: (_){
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Material(
      child: Row(
        ...
        children: [
          Expanded(child: Text('${ref.watch(uncompletedTodosCount).toString()}',
          ...
          Tooltip(
            ...
            child: FlatButton(onPressed: () => filter.state = TodoListFilter.all,
          ...
          Tooltip(
            ...
            // ignore: deprecated_member_use
            child: FlatButton(onPressed: () => filter.state = TodoListFilter.active,
                visualDensity: VisualDensity.compact,
          ...
          Tooltip(
            ...
            // ignore: deprecated_member_use
            child: FlatButton(onPressed: () => filter.state = TodoListFilter.completed,
                visualDensity: VisualDensity.compact,
    ...
    return Material(
      ...
      child: Focus(
          ...
          child: ListTile(
            ...
            leading: Checkbox(value: todo.completed, onChanged: (value) => ref.read(todoListProvider.notifier).toggle(todo.id)),
